...
const addUser = async (req, res) => {
    ...
    try {
        ...
        let result = await userService.addUser(name, email, password, image);
        if (result == false) {
...
module.exports = { addUser, userLogin, userUpdate, userUpdatePassword, userResetPassword, resetPassword, findUserProfile };